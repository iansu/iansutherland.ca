...
const InstagramIcon = (props: IconProps) => {
  ...
  const brandColor = '#E4405F';
  const brandHoverColor = colorful ? '#C02542' : brandColor;
  ...
  return (
    <BrandIcon color={iconColor} hoverColor={iconHoverColor} size={size}>
      <svg
        ...
        height={size}
        viewBox="0 0 24 24"
        id="b80c53a0-fbf6-4494-bbaf-81c896ec0e19"
        data-name="instagram-icon"
        xmlns="http://www.w3.org/2000/svg"
        fill="currentcolor"
      >
        <title>Instagram</title>
        <g id="4dc291fc-8aac-47e7-9145-5c0baf1f8afe" data-name="instagram">
